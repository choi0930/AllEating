...
public class TilesConfig{
	...
	configurer.setDefinitions(new String[] {"WEB-INF/tiles/tiles_main.xml","WEB-INF/tiles/tiles_product.xml",
			...
			"WEB-INF/tiles/tiles_owner.xml","WEB-INF/tiles/tiles_cart.xml","WEB-INF/tiles/tiles_order.xml",
			"WEB-INF/tiles/tiles_community.xml", "WEB-INF/tiles/tiles_serviceCenter.xml"
			});
