...
<html>
  ...
  <body>
    <div class="proC">
      <div class="text01"><h4>교환 신청</h4></div>
      <div class="cancel_01">
        <div class="capture">
          <img
      ...
      <form action="${contextPath}/myPage/productCancel.do" method="post">
        <div>
          <div class="reason">
            <select id="uclass">
              <option selected>교환 사유를 선택해주세요.</option>
                <option value="so">ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ</option>
                <option value="so">제품(종류/맛/개수)변경</option>
                <option value="so">주문 실수</option>
                <option value="so">파손 및 불량</option>
                <option value="so">오배송</option>
                <option value="so">기타</option>
             </optgroup>
           </select>
         </div>
          <div class="text02">
            <textarea id="text03" name="productexchange_reason" rows="9" cols="95"></textarea>
         </div>
       </div>
      <div class="text04">
         <div class="form_end">
