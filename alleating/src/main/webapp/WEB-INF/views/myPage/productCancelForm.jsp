...
<link
  href="${contextPath}/css/productcancel.css"
  rel="stylesheet"
  type="text/css"
/>
<!DOCTYPE html>
<html>
  ...
  <body>
    <div class="proC">
      <div class="text01"><h4>취소 신청</h4></div>
      <div class="cancel_01">
        <div class="capture">
          <img
      ...
      <form action="${contextPath}/myPage/productCancel.do" method="post">
        <div>
          <div class="reason">
            <select id="uclass">
              <option selected>취소 사유를 선택해주세요.</option>
                <option value="so">ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ</option>
                <option value="so">단순 변심</option>
                <option value="so">주문 실수</option>
                <option value="so">상품의 옵션 변경</option>
                <option value="so">추가 주문</option>
                <option value="so">배송 정보 변경</option>
                <option value="so">상품 가격</option>
                <option value="so">기타</option>
             </optgroup>
           </select>
         </div>
          <div class="text02">
            <textarea id="text03" name="productcancel_reason" rows="9" cols="95"></textarea>
         </div>
       </div>
      <div class="text04">
         <div class="form_end">
