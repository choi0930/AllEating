...
<link
  href="${contextPath}/css/ownermain01.css"
  rel="stylesheet"
  type="text/css"
/>
...
<html>
  ...
  <body>
    <div class="ownermain">
      ...
      <form action="${contextPath}/owner/addMember.do" method="post">
        <div class="ownertext02">
          <table>
            <tbody>
              ...
              <tr class="dot_line">
                <td class="fixed_join">상품가격</td>
                <td>
                  <input name="onwerproduct_price" type="text" size="20" />원
                </td>
              </tr>
              <tr class="dot_line">
                <td class="fixed_join">판매단위</td>
                <td>
                  <input name="onwerproduct_unit" type="text" size="20" />
                </td>
              </tr>
              <tr class="dot_line">
                <td class="fixed_join">포장타입</td>
                <td>
                  <select id="uclass">
