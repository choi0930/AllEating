...
<input id="inquiry-contents" inputmode="text" aria-label="textarea-message" name="content" value="${inquiryBoardVO.content }" class="css-5etceh e1tjt2bn1" disabled></input>
</div>
</div>
</div>
</div>
