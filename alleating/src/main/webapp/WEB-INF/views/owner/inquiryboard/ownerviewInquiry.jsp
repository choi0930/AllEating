...
<script>
     ...
     function fn_modify_article(obj){
		 obj.action="${contextPath}/owner/modArticle.do";
		 obj.submit();
	 }
...
<form  name="frmArticle" method="post" action="${contextPath}/owner/modArticle.do">
...
<input data-testid="input-box" id="inquiry-subject"  value="${inquiryBoardVO.id }"  type="text" height="44" class="css-1quw3ub e1uzxhvi2" disabled>
...
<div class="admin_personal_q_addi2">
	...
	<input type="button" value="삭제하기" class="add_submit_btn02" onClick="fn_remove_article('${contextPath}/owner/removeArticle.do', ${inquiryBoardVO.articleNO})">
</div>
</form>
</body>
</html>